...
def writeMarkdown(mdPath: Path, kpis: dict, charts: list[Path]) -> None:
    ...
    lines += [
        ...
        '<canvas id="chartMonthly" height="190"></canvas>',
        '<canvas id="chartByProject" height="190"></canvas>',
        '<canvas id="chartShare" height="190"></canvas>',
        '<canvas id="chartCumulative" height="190"></canvas>',
        "</div>",
        "",
...
def main() -> None:
    ...
    monthly = expandMonthly(projects, months=12, defaultRate=22.0)
